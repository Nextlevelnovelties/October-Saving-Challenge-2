...
$("#card").wScratchPad({
  ...
  bg: '2024octHolidaybudgettemplateNew HolidayProject2.jpg', // Background image path.
  fg: '2024halloHolidaybudgettemplateNew HolidayghostProject.jpg', // Foreground image path.
